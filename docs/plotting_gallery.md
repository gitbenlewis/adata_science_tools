...
| `datapoints_effect_panels_column`<br><small>`_plotting._column_plots`</small> | <a href="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_pvalue.png"><img src="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_pvalue.png" alt="Horizontal distributions with p-value effects" width="260"></a><br>`horizontal_pvalue` — Horizontal distributions with p-value effects<br><br><a href="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_one_effect.png"><img src="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_one_effect.png" alt="Horizontal distributions with one effect summary" width="260"></a><br>`horizontal_one_effect` — Horizontal distributions with one effect summary<br><br><a href="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_two_effects.png"><img src="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_two_effects.png" alt="Horizontal distributions with two effect summaries" width="260"></a><br>`horizontal_two_effects` — Horizontal distributions with two effect summaries<br><br><a href="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_three_effects.png"><img src="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_three_effects.png" alt="Horizontal distributions with three effect summaries" width="260"></a><br>`horizontal_three_effects` — Horizontal distributions with three effect summaries<br><br><a href="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_four_effects.png"><img src="assets/plotting_gallery/datapoints_effect_panels_column__horizontal_four_effects.png" alt="Horizontal distributions with four effect summaries" width="260"></a><br>`horizontal_four_effects` — Horizontal distributions with four effect summaries<br><br><a href="assets/plotting_gallery/datapoints_effect_panels_column__vertical_interval.png"><img src="assets/plotting_gallery/datapoints_effect_panels_column__vertical_interval.png" alt="Vertical distributions with supplied intervals" width="260"></a><br>`vertical_interval` — Vertical distributions with supplied intervals |
...
| `paired_datapoints`<br><small>`_plotting._datapoints`</small> | <a href="assets/plotting_gallery/paired_datapoints__paired_groups.png"><img src="assets/plotting_gallery/paired_datapoints__paired_groups.png" alt="Paired changes by treatment" width="260"></a><br>`paired_groups` — Paired changes by treatment<br><br><a href="assets/plotting_gallery/paired_datapoints__slope_colored_lines.png"><img src="assets/plotting_gallery/paired_datapoints__slope_colored_lines.png" alt="Paired lines colored by relative change" width="260"></a><br>`slope_colored_lines` — Paired lines colored by relative change<br><br><a href="assets/plotting_gallery/paired_datapoints__difference_axis.png"><img src="assets/plotting_gallery/paired_datapoints__difference_axis.png" alt="Varied paired slopes and signed differences" width="260"></a><br>`difference_axis` — Varied paired slopes and signed differences<br><br><a href="assets/plotting_gallery/paired_datapoints__log2fc_axis.png"><img src="assets/plotting_gallery/paired_datapoints__log2fc_axis.png" alt="Varied paired slopes and log2 fold changes" width="260"></a><br>`log2fc_axis` — Varied paired slopes and log2 fold changes<br><br><a href="assets/plotting_gallery/paired_datapoints__difference_summary_legend.png"><img src="assets/plotting_gallery/paired_datapoints__difference_summary_legend.png" alt="Baseline, post, and raw-difference summaries" width="260"></a><br>`difference_summary_legend` — Baseline, post, and raw-difference summaries<br><br><a href="assets/plotting_gallery/paired_datapoints__log2fc_summary_legend.png"><img src="assets/plotting_gallery/paired_datapoints__log2fc_summary_legend.png" alt="Baseline, post, and log2FC summaries" width="260"></a><br>`log2fc_summary_legend` — Baseline, post, and log2FC summaries<br><br><a href="assets/plotting_gallery/paired_datapoints__precomputed_pair_values.png"><img src="assets/plotting_gallery/paired_datapoints__precomputed_pair_values.png" alt="Paired values from preserved source matrices" width="260"></a><br>`precomputed_pair_values` — Paired values from preserved source matrices |
