...
- Within `_plotting`, direct regression coverage currently exists for `_corr_dotplots.py` and `_histograms.py`; the other plotting pages are based on current code and repo example usage.
